...
; What: Internal Wrapper for Win Functions
; It'd be really cool if this could update itself.

; TODO: Docstring all these so I can have a quick reference.
; First pass, working on Returns
; Eventual second pass, working on Raises
